...
if __name__ == '__main__':
    ...
    vgg_path = './initial_model/vgg16_20M.pth'
    resnet_path = './initial_model/resnet50_caffe.pth'
    ...
    # Testing settings
    parser.add_argument('--model', type=str, default='./pretrained_model/epoch_resnet.pth')
    parser.add_argument('--test_fold', type=str, default='./results/test')
    parser.add_argument('--test_mode', type=int, default=1)
    parser.add_argument('--sal_mode', type=str, default='s')
