...
class ImageDataTrain(data.Dataset):
    def __init__(self):
        ...
        self.sal_root = '/Users/hualaibaozaozhanshi/Desktop/SOD-datasets/ECSSD/ecssd'
        self.sal_source = '/Users/hualaibaozaozhanshi/Desktop/SOD-datasets/ECSSD/ecssd/test.lst'
...
class ImageDataTest(data.Dataset):
    def __init__(self, test_mode=1, sal_mode='e'):
        if test_mode == 0:
            ...
            self.image_root = '/home/yzq/dataset/HED-BSDS_PASCAL/HED-BSDS/test/'
            self.image_source = '/home/yzq/dataset/HED-BSDS_PASCAL/HED-BSDS/test.lst'
            
            
        elif test_mode == 1:
            if sal_mode == 'e':
                self.image_root = '/home/yzq/dataset/saliency_test/ECSSD/Imgs/'
                self.image_source = '/home/yzq/dataset/saliency_test/ECSSD/test.lst'
                self.test_fold = '/home/yzq/dataset/saliency_test/Result/ECSSD/'
            elif sal_mode == 'p':
                self.image_root = '/home/yzq/dataset/saliency_test/PASCALS/Imgs/'
                self.image_source = '/home/yzq/dataset/saliency_test/PASCALS/test.lst'
                self.test_fold = '/home/yzq/dataset/saliency_test/Result/PASCALS/'
            elif sal_mode == 'd':
                self.image_root = '/home/yzq/dataset/saliency_test/DUTOMRON/Imgs/'
                self.image_source = '/home/yzq/dataset/saliency_test/DUTOMRON/test.lst'
                self.test_fold = '/home/yzq/dataset/saliency_test/Result/DUTOMRON/'
            elif sal_mode == 'h':
                self.image_root = '/home/yzq/dataset/saliency_test/HKU-IS/Imgs/'
                self.image_source = '/home/yzq/dataset/saliency_test/HKU-IS/test.lst'
                self.test_fold = '/home/yzq/dataset/saliency_test/Result/HKU-IS/'
            elif sal_mode == 's':
                self.image_root = '/Users/hualaibaozaozhanshi/Desktop/SOD-datasets/SOD/Imgs/'
                self.image_source = '/Users/hualaibaozaozhanshi/Desktop/SOD-datasets/SOD/test.lst'
                self.test_fold = '/Users/hualaibaozaozhanshi/Desktop/SOD-datasets/SOD/Result/SOD/'
            elif sal_mode == 'm':
                self.image_root = '/home/yzq/dataset/saliency_test/MSRA/Imgs/'
                self.image_source = '/home/yzq/dataset/saliency_test/MSRA/test.lst'
            elif sal_mode == 'o':
                self.image_root = '/home/yzq/dataset/saliency_test/SOC/TestSet/Imgs/'
                self.image_source = '/home/yzq/dataset/saliency_test/SOC/TestSet/test.lst'
                self.test_fold = '/home/yzq/dataset/saliency_test/Result/SOC/'
            elif sal_mode == 't':
                self.image_root = '/home/yzq/dataset/DUTS/DUTS-TE/DUTS-TE-Image/'
                self.image_source = '/home/yzq/dataset/DUTS/DUTS-TE/test.lst'
                self.test_fold = '/home/yzq/dataset/saliency_test/Result/DUTS/'
        elif test_mode == 2:

            self.image_root = '/home/yzq/dataset/SK-LARGE/images/test/'
            self.image_source = '/home/yzq/dataset/SK-LARGE/test.lst'
